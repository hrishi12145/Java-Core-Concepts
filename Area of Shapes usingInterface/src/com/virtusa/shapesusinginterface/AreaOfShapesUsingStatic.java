...
public class AreaOfShapesUsingStatic {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			int side = sc.nextInt();
			Area.Square mySquare = new Area.Square(); // Create a Square Object
			...
			int bre = sc.nextInt();
			Area.Rectangle myRectangle = new Area.Rectangle(); // create a Rectangle Object
			...
			Area.Triangle myTriangle = new Area.Triangle(); // create a Triangle Object
			myTriangle.area(base, height);
			System.out.println();

			System.out.println("Enter radius for circle");
			int r = sc.nextInt();
			Area.Circles myCircle = new Area.Circles(); // create a Circle Object
			myCircle.area(r);
		}
	}
